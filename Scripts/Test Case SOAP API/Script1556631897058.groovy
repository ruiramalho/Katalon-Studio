...
response1 = WS.sendRequest(findTestObject('API/SOAP Web Services/ListCountryWebService'))

String xml1 = response1.getResponseBodyContent()

def dataValue = new XmlSlurper().parseText(xml1)
println('The extracted country code is :' +dataValue)
...
WS.sendRequest(findTestObject('API/SOAP Web Services/GetCapitalInfoWebService'))
